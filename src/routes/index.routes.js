...
const { viewPorducts, createProduct, newProduct, updateProduct, updatingProduct, deleteProduct, viewCategory } = require('../controllers/products_controller');
...
//PRODUCTS ROUTES
router.get('/productos', compression(), viewPorducts)
router.get('/newProduct', isAuthenticated, newProduct)
router.get('/productos/:category', viewCategory )
router.post('/newProduct', isAuthenticated, createProduct)
router.get('/updateProduct/:id', isAuthenticated,updateProduct)
